...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="@Txt_drm_Uploader_420_bot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+hexSGCh65UxjZjQ8"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [『ASTRONAUT』](https://t.me/+hexSGCh65UxjZjQ8) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[『ASTRONAUT』](https://t.me/+hexSGCh65UxjZjQ8)'
    else:
        CR = raw_text3
    ...
    if input6.photo:
        ...
        thumb = raw_text6
    await editable.delete()
    await m.reply_text(f"__**Batch : {b_name}**__")
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [『ASTRONAUT』](https://t.me/+hexSGCh65UxjZjQ8)"
